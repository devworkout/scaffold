    ...
    <form class="w-full p-6" method="POST" action="{{ route('register') }}">
        ...
        <div class="flex flex-col flex-wrap mb-6">
            <input id="name" placeholder="Name" type="text"
                   class="input input-minimal bg-gray-800 rounded text-gray-200 border-gray-700 w-full input input-minimal {{ $errors->has('email') ? ' border-red-500' : '' }}"
        ...
        <div class="flex flex-col flex-wrap mb-6">
            <input autocomplete="username" id="email" placeholder="Email" type="email"
        ...
        <div class="flex flex-col flex-wrap mb-6">
            ...
            <input autocomplete="new-password" id="password" placeholder="Password" type="password"
                   class="input input-minimal bg-gray-800 rounded text-gray-200 border-gray-700 w-full {{ $errors->has('password') ? ' border-red-500' : '' }}"
        ...
        <div class="flex flex-col flex-wrap mb-6">
            ...
            <input autocomplete="new-password" id="password_confirmation" placeholder="Confirm Password"
                   type="password"
                   class="input input-minimal bg-gray-800 rounded text-gray-200 border-gray-700 w-full {{ $errors->has('password_confirmation') ? ' border-red-500' : '' }}"
