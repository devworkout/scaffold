        ...
        <form class="w-full p-6" method="POST" action="{{ route('login') }}">
            ...
            <div class="flex flex-col flex-wrap mb-6">
                <input autocomplete="current-password" id="password" placeholder="Password" type="password"
                       class="input bg-gray-800 rounded text-gray-200 input-minimal border-gray-700 w-full {{ $errors->has('password') ? ' border-red-500' : '' }}"
            ...
            <div class="flex flex-wrap w-full items-center pt-8">
                <button type="submit"
                        class="btn text-gray-400 font-normal bg-gray-700 rounded hover:bg-gray-800 rounded">
                    Sign In
                </button>
